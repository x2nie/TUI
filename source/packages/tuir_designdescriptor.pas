...
begin
  Result:=ProjectFileDescriptors.FindByName('TUIRForm');
end;
...
begin
  Result:='Create a new Form for TUIR Console Application';
end;
...
begin
  Result := 'TUIR Application'+LineEnding+LineEnding
...
begin
  Result := 'TUIR Console Application';
end;
...
begin
  ...
  AProject.AddPackageDependency('Tuir_runtime');
